package com.demo.financialcalculator.model;
...
public class MonthModel implements Parcelable {
    ...
    public MonthModel(double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, int i, int i2, Date date2) {
